...
export default function DashboardShell({
 ...
 className={`flex-shrink-0 px-3.5 py-1.5 rounded-full text-xs font-semibold border ${filter === item.key ? 'bg-[#16161a] border-[#2a2a33] text-white' : 'border-[#1f1f26] text-gray-500'}`}>
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <a href="/dashboard/new" className="lg:hidden bg-[#8b3cf7] hover:bg-[#9d55f8] text-white font-semibold px-3.5 py-1.5 rounded-lg text-xs">+ New</a>
          </div>
 ...
 className={`group bg-[#101013] border rounded-xl p-4 flex items-center justify-between ${paid ? 'border-[#16161a] hover:border-green-400/20 opacity-80 hover:opacity-100' : 'border-[#16161a] hover:border-[#8b3cf7]/40'}`}>
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                      ...
                      <svg className="w-4 h-4 text-gray-600 group-hover:text-[#8b3cf7]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" /></svg>
                    </div>
                  </a>
                )
              })}
